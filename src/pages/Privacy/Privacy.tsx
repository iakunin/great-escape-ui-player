...
function HomepageLink(): JSX.Element {
  return <a href={appConfig.baseUrl}>https://great&#8209;escape.ru</a>;
}

function CurrentPageLink(): JSX.Element {
  const route = Routes.Privacy;
  const href = appConfig.baseUrl + route;

  return <a href={href}>https://great&#8209;escape.ru{route}</a>;
}

function EmailLink(): JSX.Element {
  return <a href={`mailto:${appConfig.email.info}`}>{appConfig.email.info}</a>;
}

// Данная Политика сгенерирована при помощи следующего
// веб-ресурса: https://tilda.cc/ru/privacy-generator/
      ...
      <div className={styles.content}>
        ...
        <div className={styles.section}>
          ...
          <div className={styles.item}>
            ...
            по обеспечению безопасности персональных данных, предпринимаемые ИП Якунин Максим
        ...
        <div className={styles.section}>
          ...
          <div className={styles.item}>
            ...
            определенному или определяемому Пользователю веб-сайта {HomepageLink()}.
          </div>
          <div className={styles.item}>
          ...
          <div className={styles.item}>
            2.10. Пользователь – любой посетитель веб-сайта {HomepageLink()}.
          </div>
          <div className={styles.item}>
        ...
        <div className={styles.section}>
          ...
          <div className={styles.item}>
            ...
            содержащимся на веб-сайте {HomepageLink()};<br/>
            – отправка кодов подтверждения бронирования посредством отправки СМС-сообщений.
          </div>
          <div className={styles.item}>
            ...
            электронной почты {EmailLink()} с пометкой «Отказ от уведомлений о новых продуктах и
        ...
        <div className={styles.section}>
          ...
          <div className={styles.item}>
            ...
            расположенные на сайте {HomepageLink()} или направленные Оператору посредством
        ...
        <div className={styles.section}>
          <h2>10. Порядок сбора, хранения, передачи и других видов обработки персональных
            данных</h2>
          <div className={styles.item}>
          ...
          <div className={styles.item}>
            ...
            электронной почты Оператора {EmailLink()} с пометкой «Актуализация персональных
            данных».
          </div>
          <div className={styles.item}>
            ...
            адрес Оператора {EmailLink()} с пометкой «Отзыв согласия на обработку
            персональных данных».
          </div>
          <div className={styles.item}>
        ...
        <div className={styles.section}>
          <h2>11. Перечень действий, производимых Оператором с полученными персональными
            данными</h2>
          <div className={styles.item}>
